...
#######################################################
plt.bar(x1, A7v1[40], width=1, color='#1f77b4', alpha=0.3)#bottom=A7c1[-1])
plt.bar(x2, A7v2[40], width=1, color='#ff7f0e', alpha=0.3)#bottom=A7c2[-1])
plt.bar(x3, A7v3[40], width=1, color='#2ca02c', alpha=0.3)#bottom=A7c3[-1])
plt.bar(x4, A7v4[40], width=1, color='#d62728', alpha=0.3)#bottom=A7c4[-1])

plt.bar(x1, A7v1[-1], width=1, color='#1f77b4')
plt.bar(x2, A7v2[-1], width=1, color='#ff7f0e')
plt.bar(x3, A7v3[-1], width=1, color='#2ca02c')
plt.bar(x4, A7v4[-1], width=1, color='#d62728')
...
tikz_save('Graphs/barA7v.tikz', figureheight='8cm', figurewidth='13.69785cm')